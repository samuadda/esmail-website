    ...
    return (
        <LampContainer>
            <motion.h1
                ...
                className="mt-8 bg-gradient-to-br from-[#0d2b4c] to-[#28bea1] py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
            >
        ...
        <div className={cn("absolute -top-80 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white bg-opacity-70 w-full z-0", className)}>
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                <motion.div
                    ...
                    className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#28bea1] via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
                >
                ...
                <motion.div
                    ...
                    className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#28bea1] text-white [--conic-position:from_290deg_at_center_top]"
                >
                ...
                <motion.div
                    ...
                    className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-[#28bea1] blur-2xl"
                ></motion.div>
                <motion.div
                    initial={{ width: "30rem" }}
                    ...
                    className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-[#28bea1]" //the main bar
                ></motion.div>
